...
var _require2 = require('./reset/resetDB'),
  resetDB = _require2.resetDB;
var app = express();
...
var _require3 = require('./constants/resErrorJson'),
  sendErrorLog = _require3.sendErrorLog;
var _require4 = require('./middlewares'),
  apiLimiter = _require4.apiLimiter;
app.use(cors({
